	    ...
	    echo "<script>alert('YOU HAVE EXCEEDED YOUR LEAVE LIMIT. LEAVE APPLICATION FAILED');</script>";
            ...
            if (filter_var($staffEmailId, FILTER_VALIDATE_EMAIL)) {
                ...
                if (filter_var($hEmailId, FILTER_VALIDATE_EMAIL)) {
                    $sql="INSERT INTO tblleave(LeaveType, ToDate, FromDate, RequestedDays, DaysOutstand,HodRemarks,RegRemarks,IsRead,empid,num_days,PostingDate)	VALUES('$leave_type','$todate','$fromdate', '$requested_days','$leave_days','$hod_status','$reg_status','$isread','$empid', '$requested_days', '$datePosting')";
                        ...
                        <form method="post" action="">
                            <section>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label>Number of Days still outstanding </label>
