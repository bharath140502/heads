	...
	<div class="main-container">
		<div class="pd-ltr-20">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">MY LEAVE HISTORY</h2>
					</div>
				<div class="pb-20">
                                  ...
                                  <td><?php echo htmlentities($result->num_days);?></td>
								   ...
								   <td>
									  <div class="table-actions">
										<a title="VIEW" href="view_my_leaves.php?edit=<?php echo htmlentities($result->id);?>" data-color="#265ed7"><i class="icon-copy dw dw-eye"></i></a>
									  </div>
								   </td>
							</tr>
							<?php $cnt++;} }?>  
