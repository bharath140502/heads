...
if(isset($_POST['new_update']))
{
    ...
    $result = mysqli_query($conn,"update tblemployees set  Address='$address', Phonenumber='$phonenumber' where emp_id='$session_id' ")or die(mysqli_error());
    if ($result) {
											...
											<div class="profile-setting">
												<form method="POST" enctype="multipart/form-data">
													<div class="profile-edit-list row">
														<div class="col-md-12"><h4 class="text-blue h5 mb-20">Edit Your Personal Information</h4></div>
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<input name="dob" class="form-control form-control-lg" type="text" placeholder="" required="true" autocomplete="off" readonly value="<?php echo $row['Dob']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
																<label>Gender</label>
																<input name="gender" class="form-control form-control-lg" type="text" placeholder="" required="true" autocomplete="off" readonly value="<?php echo $row['Gender']; ?>">
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<input name="department" class="form-control form-control-lg" type="text" placeholder="" required="true" autocomplete="off" readonly value="<?php echo $row['Department']; ?>">
														...
														<div class="weight-500 col-md-6">
															...
															<div class="form-group">
																...
																<input class="form-control form-control-lg" type="text" required="true" autocomplete="off" readonly value="<?php echo $row['CasualLeave']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<?php
															...
															?>
															<div class="form-group">
																<label>Available Sick Leave Days</label>
																<input class="form-control form-control-lg" type="text" required="true" autocomplete="off" readonly value="<?php echo $row['SickLeave']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<?php
															...
															?>
															<div class="form-group">
																<label>Available Privilege Leave Days</label>
																<input class="form-control form-control-lg" type="text" required="true" autocomplete="off" readonly value="<?php echo $row['PrivilageLeave']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
