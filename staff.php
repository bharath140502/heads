	...
	<div class="main-container">
		<div class="pd-ltr-20">
			<!-- <div class="title pb-20">
				<h2 class="h3 mb-0">Department Employee View</h2>
			</div> -->
			<!-- <div class="row pb-10">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">DEPARTMENT  MEMBERS</h2>
					</div>
				<div class="pb-20">
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											...
											<a class="dropdown-item" href="edit_staff.php?edit=<?php echo $row['emp_id'];?>"><i class="dw dw-eye"></i> view</a>
